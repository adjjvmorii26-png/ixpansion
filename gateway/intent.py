...
INTENT_PATTERNS: List[Tuple[str, str, dict]] = [
    ...
    (r"\b(memory (exchange|market|trade|ticker|auction|swap|economy)|trade memories|buy a memory|sell a memory|memory coins|swap memories|shared memory)\", "/api/memory_exchange", {}),
