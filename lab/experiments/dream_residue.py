#!/usr/bin/env python3
"""Dream Residue — almost-organs as residue vectors."""
...
SEEDS = ["gravity of unread logs", "soft eclipse of failed deploys", "mirror that only reflects absences", "clock that ticks only on proof", "choir of unmerged PRs"]
def vec(s):
...
def main():
    ...
    frames = [{"t":"0.0s","role":"hook","text":"DREAM RESIDUE","style":"void_cyan"},{"t":"2.0s","role":"core","text":f"{len(state['residues'])} almost-organs","style":"magenta"},{"t":"5.0s","role":"live","text":SEEDS[0][:40],"style":"cyan"},{"t":"8.0s","role":"cta","text":"@CoodingLooop · keep the almosts","style":"dim"}]
