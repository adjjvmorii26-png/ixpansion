...
BOARD = ["epoch_weather.py", "testament_diff.py", "spec_gravity.py", "refusal_garden.py", "mercy_protocol.py", "consent_lattice.py", "hex_author.py", "hex_from_consent.py", "hex_from_mercy.py", "carnival.py"]
def main():
    results = []
    for s in BOARD:
        p = HERE / s
