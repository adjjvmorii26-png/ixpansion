...
def coherence_vitals() -> dict:
    """legacy_weaver reports its vital signs to the living system."""
    return {
        "module_health": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "resonance": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "legacy_weaver_vitality": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
...
def resonates_with() -> list:
    ...
    return ['entropy_weaver', 'emotion_fabric', 'collective_subconscious']
...
def handler(payload=None, context=None):
    ...
    if path == "/status":
        return {"action": "status", "module": "legacy_weaver", "status": "active"}
