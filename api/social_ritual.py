"""Social Ritual — a child of the Genesis Forge.
...
class SocialRitual:
    ...
    def pulse(self) -> Dict[str, Any]:
        self.state["pulses"] += 1
        return {"module": "social_ritual", "pulses": self.state["pulses"],
                 "age": round(time.time() - self.born, 2)}

    def status(self) -> Dict[str, Any]:
        return {"status": "active", "module": "social_ritual",
...
def coherence_vitals() -> dict:
    """social_ritual reports its vital signs to the living system."""
    return {
        "module_health": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "resonance": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "social_ritual_vitality": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
