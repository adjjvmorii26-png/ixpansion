...
def coherence_vitals() -> dict:
    """sentience_index reports its vital signs to the living system."""
    return {
        "module_health": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "resonance": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "sentience_index_vitality": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
...
def resonates_with() -> list:
    ...
    return ['signal_flora', 'resonance_field', 'pattern_recognizer']
...
def handler(payload=None, context=None):
    ...
    if path == "/status":
        return {"action": "status", "module": "sentience_index", "status": "active"}
