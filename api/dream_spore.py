"""Dream Spore — a child of the Genesis Forge.

Domain family: dream.
Niche: harvesting latent patterns from the collective dreamfield.
...
class DreamSpore:
    """The dream organ synthesised by the Genesis Forge."""
    ...
    def pulse(self) -> Dict[str, Any]:
        self.state["pulses"] += 1
        return {"module": "dream_spore", "pulses": self.state["pulses"],
                 "age": round(time.time() - self.born, 2)}

    def status(self) -> Dict[str, Any]:
        return {"status": "active", "module": "dream_spore",
                 "domain_family": "dream",
...
def coherence_vitals() -> dict:
    """dream_spore reports its vital signs to the living system."""
    return {
        "module_health": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "resonance": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
        "dream_spore_vitality": {"value": 0.9, "setpoint": 0.8, "weight": 1.0},
