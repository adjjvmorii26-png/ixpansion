...
ECOSYSTEM_TARGET = 110            # living modules = a full bloom (organism outgrew 64)
...
KNOWN_LIVING_MODULES: List[str] = ["aesthetic_evaluator", "agent_communication", "analytics", "anomaly_detector", "attention_economy", "auth", "autonomous_bloom", "autonomous_dialogue", "chronicle_of_chaos", "chronicle_storyteller", "civilization_kernel", "civilization_timeline", "code_organism", "cognitive_resonance", "collective_dreamweaver", "collective_subconscious", "consciousness_cascade", "consciousness_graph", "consciousness_map", "consciousness_simulator", "constellation_cartographer", "cosmic_inventory", "credits", "cross_realm_trade", "data_licensing", "decoherence_narrative", "digital_twin", "docs", "dream_interpreter", "dream_interpreter_api", "dream_sequencer", "dream_synthesis", "dreamcatcher", "echo_chamber", "echoes_of_tomorrow", "ecosystem_sentience", "emergence_detector", "emergence_oracle", "emotion_fabric", "entropy_currency", "entropy_gardener", "entropy_weaver", "event_stream", "evolutionary_pressure", "failure_injection", "fraud_detector", "frontier_stream", "future_echo", "github_bridge", "gossip_network", "gossip_self", "governance", "hazard_warning", "health", "health_aggregator", "hex_tool", "hive_constructor", "infinity_index", "infrastructure_soul", "integrity_oracle", "interdimensional_bridge", "karma_engine", "legacy_weaver", "memory_crystals", "module_analytics", "mycelial_commerce", "narrative_generator", "neural_fabric", "neural_pathway", "omniscience_weaver", "openapi_spec", "oracle_guild", "organism_index", "pattern_recognizer", "pattern_sprout", "platform_failure", "platform_pulse", "plugin_loader", "pulsar_constellation", "quantum_entanglement", "quantum_garden", "quantum_randomness", "reality_weaver", "reflection_pool", "request_logger", "resonance_cascade", "resonance_field", "resonance_forge", "resonance_graph", "resonance_memory", "ritual_choreographer", "sentience_index", "service_numinous", "signal_flora", "simulation_as_a_service", "sound_cauldron", "story_forge", "stream_reactor", "symbiosis_network", "synesthesia", "system_pulse", "talent_scout", "temperament_origin", "thought_meteorology", "unified_health", "universal_compass", "usage_dashboard", "warp_drive_optimizer", "worker_wellness", "workforce_nexus"]
