...
ECOSYSTEM_TARGET = 90            # living modules = a full bloom (organism outgrew 64)
...
KNOWN_LIVING_MODULES: List[str] = ["aesthetic_evaluator", "agent_communication", "analytics", "anomaly_detector", "attention_economy", "auth", "autonomous_bloom", "autonomous_dialogue", "chronicle_of_chaos", "chronicle_storyteller", "civilization_kernel", "civilization_timeline", "code_organism", "cognitive_resonance", "collective_dreamweaver", "collective_subconscious", "consciousness_cascade", "consciousness_graph", "consciousness_map", "consciousness_simulator", "constellation_cartographer", "cosmic_inventory", "credits", "cross_realm_trade", "data_licensing", "decoherence_narrative", "digital_twin", "docs", "dream_interpreter", "dream_interpreter_api", "dream_sequencer", "dream_synthesis", "dreamcatcher", "echo_chamber", "echoes_of_tomorrow", "emergence_detector", "emergence_oracle", "emotion_fabric", "entropy_currency", "entropy_gardener", "entropy_weaver", "event_stream", "evolutionary_pressure", "failure_injection", "fraud_detector", "frontier_stream", "future_echo", "github_bridge", "gossip_network", "gossip_self", "hazard_warning", "health_aggregator", "hex_tool", "hive_constructor", "infinity_index", "infrastructure_soul", "integrity_oracle", "karma_engine", "memory_crystals", "module_analytics", "narrative_generator", "neural_fabric", "neural_pathway", "omniscience_weaver", "openapi_spec", "organism_index", "pattern_recognizer", "pattern_sprout", "platform_failure", "platform_pulse", "plugin_loader", "quantum_garden", "quantum_randomness", "reality_weaver", "reflection_pool", "resonance_field", "resonance_forge", "resonance_graph", "ritual_choreographer", "sentience_index", "signal_flora", "sound_cauldron", "stream_reactor", "synesthesia", "system_pulse", "thought_meteorology", "universal_compass", "usage_dashboard", "worker_wellness", "workforce_nexus"]
