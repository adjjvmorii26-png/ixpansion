"""Wave 999 — spark_cathedral.

Strengthen the organism's spark layer, compensating for weakness in ?.
"""
...
DATA_FILE = ROOT / "data" / "wave999_spark_cathedral.json"
WAVE = 999
NAME = "spark_cathedral"
