"""luma_interface — Garden governance/interface/seed module."""
...
MODULE_NAME = "luma_interface"
STATE_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "luma_interface.json")
