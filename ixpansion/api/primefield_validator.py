"""primefield_validator — Garden governance/interface/seed module."""
...
MODULE_NAME = "primefield_validator"
STATE_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "primefield_validator.json")
