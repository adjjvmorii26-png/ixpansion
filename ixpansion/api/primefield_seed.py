"""primefield_seed — Garden governance/interface/seed module."""
...
MODULE_NAME = "primefield_seed"
STATE_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "primefield_seed.json")
