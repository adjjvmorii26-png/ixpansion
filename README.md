...
| [`chrono_forge`](lab/chrono_forge/) | Python | 55 | Pinned ritual automation: pulse heartbeat, sentinel invariants, sandbox entropy budget, Forge Mind triage, and proof runner |
...
The complete monorepo suite contains **592 tests**.
