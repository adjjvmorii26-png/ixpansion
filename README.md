...
| [`chrono_forge`](lab/chrono_forge/) | Python | 75 | Pinned ritual automation: pulse heartbeat, sentinel invariants, sandbox entropy budget, Forge Mind triage, and proof runner |
...
The complete monorepo suite contains **612 tests**.
