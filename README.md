...
> *The Computational Frontier* — 329 API modules, 157 experiments, 907 tests
...
├── vercel.json             # Deployment config (336 routes, 3 regions)
├── tests/                  # 39 test files, 907 test functions
...
```bash
python -m pytest tests/ -v          # full suite (907 tests)
