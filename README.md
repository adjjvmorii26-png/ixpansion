...
| [`chrono_forge`](lab/chrono_forge/) | Python | 14 | Pinned ritual automation: pulse heartbeat, sentinel invariants, sandbox entropy budget, Forge Mind triage, and proof runner |
