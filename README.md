...
> *The Computational Frontier* — 273 API modules, 157 experiments, 844 tests
...
├── vercel.json             # Deployment config (280 routes, 3 regions)
├── tests/                  # 39 test files, 844 test functions
