...
> *The Computational Frontier* — 321 API modules, 157 experiments, 898 tests
...
├── vercel.json             # Deployment config (328 routes, 3 regions)
├── tests/                  # 39 test files, 898 test functions
...
```bash
python -m pytest tests/ -v          # full suite (898 tests)
